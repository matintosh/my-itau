...
my-itau exposes an [MCP](https://modelcontextprotocol.io) server so AI agents (Claude, etc.) can query your banking data directly.
...
Restart Claude Desktop. Claude can now answer questions like:

- *"How much did I spend in March?"*
- *"List my transactions at Tienda Inglesa this month."*
- *"What's my current account balance?"*

### HTTP transport (running server)

If you're already running `my-itau serve`:
